...
public class ProductControllerTest {
    ...
    private final static String URL = "http://localhosts:8080/api/v1/product";
    ...
    public void findByIdTest() throws Exception {
        mockMvc.perform(get("http://localhosts:8080/api/v1/product/{id}","1"))
                .andExpect(status().isOk());
    }
    @Test
    public void deleteTest() throws Exception {
        mockMvc.perform(delete("http://localhosts:8080/api/v1/product/{id}","3"))
